  ...
  render() {
    return (
      <div className="Dash-page">
      	...
      	<Helmet>
	      <title>Dash | Crypto Watcher</title>
	    </Helmet>

        <NavBar />
		<section className="container" id="exchanges">

			<h2 className="title text-center">Dash Price History</h2>
	...
	componentDidMount() {
		...
		const apiDashPriceList = 'https://min-api.cryptocompare.com/data/histoday?fsym=DASH&tsym=USD&limit=11&aggregate=3';
		fetch(apiDashPriceList)
		.then((resp) => resp.json())
		.then(function(data) {
